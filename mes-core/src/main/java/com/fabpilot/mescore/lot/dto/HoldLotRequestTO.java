...
/** Hold 请求：原因解释为什么暂停，成功后只改变独立 Hold 状态。 */
@Data
@EqualsAndHashCode(callSuper = true)
@NoArgsConstructor
public class HoldLotRequestTO extends VersionedCommandRequestTO {
    ...
    public HoldLotRequestTO(Long expectedVersion, String idempotencyKey, String operatorId,
