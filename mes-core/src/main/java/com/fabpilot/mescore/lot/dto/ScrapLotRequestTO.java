...
/** Scrap 请求：报废是不可逆终态，必须提供可审计的明确原因。 */
@Data
@EqualsAndHashCode(callSuper = true)
@NoArgsConstructor
public class ScrapLotRequestTO extends VersionedCommandRequestTO {
    ...
    public ScrapLotRequestTO(Long expectedVersion, String idempotencyKey, String operatorId,
